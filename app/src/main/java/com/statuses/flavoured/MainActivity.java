...
import com.statuses.flavoured.Interstitial.InterstitialMainApp;
import com.statuses.flavoured.fragments.whatsapp.WhatsappFragment;
...
public class MainActivity extends InterstitialMainApp
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            if (!isMyServiceRunning(Class.forName("com.statuses.flavoured.service.NotificationService"))) {
                try {
                    startService(new Intent(this, Class.forName("com.statuses.flavoured.service.NotificationService")));
                } catch (Throwable e) {
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        // Handle the camera action
            ...
            if(checkInstallation("com.com.statuses.flavoured.fragments.whatsapp.w4b")) {
