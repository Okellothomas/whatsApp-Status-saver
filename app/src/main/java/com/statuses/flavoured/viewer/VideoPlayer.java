package com.statuses.flavoured.viewer;
...
import com.statuses.flavoured.BuildConfig;
import com.statuses.flavoured.HelperMethods;
import com.statuses.flavoured.Interstitial.IntertsitialAdmob;
...
//               return new SomeClass(this, file);
                    ...
                    IntertsitialAdmob.mInterstitialAd.show(VideoPlayer.this);

                    IntertsitialAdmob.mInterstitialAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                        @Override
                        public void onAdDismissedFullScreenContent() {
                            super.onAdDismissedFullScreenContent();

                            IntertsitialAdmob.mInterstitialAd = null;
                            IntertsitialAdmob.loadInter(VideoPlayer.this);
                        }
                    });

//                          return new ImageViewer.SomeClass(this, file);
                }
...
//                }
        ...
        delete_fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
              ...
              builder.setMessage("Sure to Delete this Video?").setNegativeButton("Nope", new DialogInterface.OnClickListener() {
